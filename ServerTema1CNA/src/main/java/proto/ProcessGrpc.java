...
public final class ProcessGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto.Server.Request,
      proto.Server.Response> getProcessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "process",
      requestType = proto.Server.Request.class,
      responseType = proto.Server.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.Server.Request,
      proto.Server.Response> getProcessMethod() {
    io.grpc.MethodDescriptor<proto.Server.Request, proto.Server.Response> getProcessMethod;
      ...
      synchronized (ProcessGrpc.class) {
        if ((getProcessMethod = ProcessGrpc.getProcessMethod) == null) {
          ProcessGrpc.getProcessMethod = getProcessMethod = 
              io.grpc.MethodDescriptor.<proto.Server.Request, proto.Server.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Process", "process"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Server.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.Server.Response.getDefaultInstance()))
  ...
  public static abstract class ProcessImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void process(proto.Server.Request request,
        io.grpc.stub.StreamObserver<proto.Server.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proto.Server.Request,
                proto.Server.Response>(
  ...
  public static final class ProcessBlockingStub extends io.grpc.stub.AbstractStub<ProcessBlockingStub> {
    ...
    /**
     */
    public proto.Server.Response process(proto.Server.Request request) {
  ...
  public static final class ProcessFutureStub extends io.grpc.stub.AbstractStub<ProcessFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.Server.Response> process(
        proto.Server.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS:
          serviceImpl.process((proto.Server.Request) request,
              (io.grpc.stub.StreamObserver<proto.Server.Response>) responseObserver);
          break;
        default:
